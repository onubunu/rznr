...
class ContactMessagesControllerTest < ActionController::TestCase
  ...
  test "should create contact_message" do
    assert_difference('ContactMessage.count') do
      post :create, contact_message: { email: @contact_message.email, message: @contact_message.message, name: @contact_message.name }
    end
  ...
  test "should update contact_message" do
    put :update, id: @contact_message, contact_message: { email: @contact_message.email, message: @contact_message.message, name: @contact_message.name }
    assert_redirected_to contact_message_path(assigns(:contact_message))
  end
